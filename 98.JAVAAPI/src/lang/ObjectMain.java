...
public class ObjectMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(o2);
		 if(o1.equals(o2)) {
			 System.out.println("o1과 o2 주소가동일하다.[equals]");
		 }else {
			 System.out.println("o1과 o2 주소가동일하지않다.[equals]");
		 }
		 if(o1.equals(o3)) {
			 
			 System.out.println("o1과 o3 주소가동일하다.[equals]");
		 }else {
			 System.out.println("o1과 o3 주소가동일하지않다.[equals]");
		 ...
		 ObjectChild oc3=oc1;
		 System.out.println("----상속받은 Objects.equals-----");
		 if(oc1.equals(oc3)) {
			 System.out.println("oc1과 oc3주소가동일하다.");
		 }
		 System.out.println("----상속받은 Objects.toString-->재정의----");
