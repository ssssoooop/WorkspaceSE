...
public class StudentServiceArrayFrameMain  extends JFrame{
	...
	private JButton calculateTotAvgGradeBtn;
	...
	public StudentServiceArrayFrameMain() {
		...
		calculateTotAvgGradeBtn = new JButton("1. 전체학생총점,평균,평점계산");
		StudentServiceArrayList studentService=new StudentServiceArrayList();
		calculateTotAvgGradeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("1. 전체학생총점,평균,평점계산");
				studentService.calculate();
			}
		});
		calculateTotAvgGradeBtn.setBounds(42, 34, 700, 40);
		getContentPane().add(calculateTotAvgGradeBtn);
