...
public class FileMain {
	...
	public static void main(String[] args) throws Exception{
		/*
		 * 현재파일경로[기준경로]
		 * 		eclipse-->C:\2022-11-JAVA-DEVELOPER\workspaceSE\20.입출력[10]
		 * 
		 * 상대경로(relative) 경로
		 * 		현재경로를 기준으로 경로를기술
		 * 		sample/a.txt
		...
		File file4=new File("C:\\>C:\\2022-11-JAVA-DEVELOPER\\workspaceSE\\20.입출력[10]");
		...
		System.out.println(">> newDir1 디렉토리생성:"+newDir2.mkdir());
		System.out.println(">> newDir1 디렉토리생성:"+newDir3.mkdir());
		System.out.println(">> newDir1 디렉토리생성:"+newDir4.mkdir());
		...
		File newFile2=new File("newDir1","newFile1.txt");
