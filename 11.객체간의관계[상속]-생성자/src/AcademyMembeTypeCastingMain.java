...
public class AcademyMembeTypeCastingMain {
	...
	public static void main(String[] args) {
		/*
		 ...
		 AcademyMember의 자식타입객체(AcademyStudent_AcademyGangsa,AcademyStaff)들은
		...
		AcademyMember m7=new AcademyStaff(7,"박승은","원장");
		
		/****AcademyMember에정의되지않은 메쏘드호출불가능*****
		String ban=m1.getBan();
		********************************************************/
		/****AcademyMember 에정의된 메쏘드중 재정의된메쏘드호출가능******
		...
		System.out.println("---------AcademyMember들--------");
		m1.print();
		m2.print();
		m3.print();
		m4.print();
