...
class Parent extends Object{
	...
	public Parent(int member1, int member2) {
		...
		System.out.println("2.public Object()생성자호출");
		System.out.println("");
...
class Child extends Parent{
	...
	public Child(int member1,int member2,int member3) {
		super(member2,member2);
		/*
		 * <<The field Parent.member1 is not ivisible>>
		 * this.member1=member1;
		 * this.member2=member2;
		 */

		this.member3=member3;
		System.out.println("(member1,member2,member3)생성자 호출");
	}
	public void method3() {
